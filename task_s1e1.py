...
def post_task_answer(base_url: str, xyz_agents_username: str, xyz_agents_pass: str, year: int):
...
def solve_task(base_url: str, ai_devs_key: str, openai_key: str, xyz_agents_username: str, xyz_agents_pass: str, system_prompt: str):
